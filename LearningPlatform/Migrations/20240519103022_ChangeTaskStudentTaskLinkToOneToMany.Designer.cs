...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240519103022_ChangeTaskStudentTaskLinkToOneToMany")]
    partial class ChangeTaskStudentTaskLinkToOneToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("79651912-e3f9-4027-aa85-de0694f49ea9"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$F.iTzGGWRRIMD6hB/vMYB.w0KLCcdqXV6UG20k/qzVGoyCK7kcl4S",
                            Role = 0
                        });
                });
