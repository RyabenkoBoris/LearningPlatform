...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240518133946_AddStudentTaskAndDates")]
    partial class AddStudentTaskAndDates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f78d5af-b77b-4535-a55c-9c019f428b38"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$gmNsIAGQ4L12dRRhozgHIOPw4F0SOs7seSModOtysMfObkvuPcDMi",
                            Role = 0
                        });
                });
            ...
            modelBuilder.Entity("LearningPlatform.Models.StudentTaskEntity", b =>
                {
                    b.HasOne("LearningPlatform.Models.TaskEntity", "Task")
                        .WithOne("StudentTask")
                        .HasForeignKey("LearningPlatform.Models.StudentTaskEntity", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
