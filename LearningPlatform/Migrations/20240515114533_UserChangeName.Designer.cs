...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240515114533_UserChangeName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningPlatform.Models.DepartamentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LearningPlatform.Models.NumberEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a30fe03f-2a8c-43e9-aaa6-4ca8321241c7"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$d6x.xeLkp6DjkEjPdQuXnew2m.fu3hyT.G6j60VjXRElrp56I/vXu",
                            Role = 0
                        });
                });
            ...
            modelBuilder.Entity("LearningPlatform.Models.GroupEntity", b =>
                {
                    b.HasOne("LearningPlatform.Models.DepartamentEntity", "Departament")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasOne("LearningPlatform.Models.NumberEntity", "Number")
                        .WithMany("Users")
