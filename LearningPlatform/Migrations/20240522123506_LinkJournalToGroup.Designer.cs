...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240522123506_LinkJournalToGroup")]
    partial class LinkJournalToGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupEntityJournalEntity", b =>
                {
                    b.Property<int>("GroupsId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("GroupsId", "JournalsId");

                    b.HasIndex("JournalsId");

                    b.ToTable("GroupEntityJournalEntity");
                });
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd93548d-7d4a-4cce-a22f-e03577688918"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$jzBvNowGVpaDJQaGNhtLOe2nA/WmckxK.nv6cfHGCB96JFcMqhDfu",
                            Role = 0
                        });
                });
