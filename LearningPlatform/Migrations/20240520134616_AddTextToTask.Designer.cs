...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240520134616_AddTextToTask")]
    partial class AddTextToTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("804101dd-6316-4021-a25b-3cb681ba290c"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$a4hwAK1eYY1qh4Tn9tJU9.rJzAsWXIVeY9/oYcbyB2GMhwcUSxO8m",
                            Role = 0
                        });
                });
