...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240522130705_ChangeJournalGroupLinkToManyToOne")]
    partial class ChangeJournalGroupLinkToManyToOne
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4793881d-5c10-41c7-83d4-af386afc413f"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$aBFhO0rYOgMaVQEk1/ZkX.ZZB6sIR3PM.l8XLP5NGMufbU5k24/BW",
                            Role = 0
                        });
                });
