...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240523102406_ChangeDateOnlyToDateTimeInGrade")]
    partial class ChangeDateOnlyToDateTimeInGrade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d379d82c-94a2-4687-be2a-488ca4a36630"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$ke3AbyC5iNjIvVP.tDFaDujl2/mOZe7cTRWVZIYbkLk7zigE.Ysae",
                            Role = 0
                        });
                });
