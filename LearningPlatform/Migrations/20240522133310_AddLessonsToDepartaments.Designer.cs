...
namespace LearningPlatform.Migrations
{
    ...
    [Migration("20240522133310_AddLessonsToDepartaments")]
    partial class AddLessonsToDepartaments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartmentEntityLessonEntity", b =>
                {
                    ...
                    b.ToTable("DepartmentEntityLessonEntity");
                });
            ...
            modelBuilder.Entity("JournalEntityTeacherEntity", b =>
                {
                    ...
                    b.ToTable("JournalEntityTeacherEntity");
                });
            ...
            modelBuilder.Entity("LearningPlatform.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7ef91e9b-f57f-41bb-9980-037f23d25166"),
                            Email = "admin@admin",
                            Name = "Admin",
                            PasswordHash = "$2a$11$Kyhlq0aXr0paDXDB2QkGr.4RKni6PkbBGflZFShjmw.oMeddo49UC",
                            Role = 0
                        });
                });
            ...
            modelBuilder.Entity("DepartmentEntityLessonEntity", b =>
                {
                    b.HasOne("LearningPlatform.Models.DepartmentEntity", null)
                        .WithMany()
